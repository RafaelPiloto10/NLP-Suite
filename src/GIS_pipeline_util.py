...
def GIS_pipeline(window, inputFilename, outputDir,
    ...
    if inputIsCoNLL == True:
        ...
        locations = GIS_location_util.extract_csvFile_locations(window, inputFilename, withHeader, locationColumnNumber,
                                                                encodingValue)
    ...
    if InputIsGeocoded == False:  # the input file is NOT already geocoded
        ...
        geocodedLocationsoutputFilename, locationsNotFoundoutputFilename = GIS_geocode_util.geocode(window, locations,
                                                                                                    inputFilename,
                                                                                                    outputDir,
                                                                                                    locationColumnName,
                                                                                                    geocoder,
    ...
    if mapping_package == 'Google Earth Pro':
        ...
        kmloutputFilename = GIS_KML_util.generate_kml(window, inputFilename, geocodedLocationsoutputFilename,
                                                      ...
                                                      encodingValue,
                                                      group_number_var, italic_var, bold_var, italic_var_list,
                                                      bold_var_list,
                                                      location_var,
